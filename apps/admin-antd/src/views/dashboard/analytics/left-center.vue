...
import userAll from '#/assets/data/user-all.json';
...
const getData = () => {
  state.lockNum = userAll.lockNum;
  state.offlineNum = userAll.offlineNum;
  state.onlineNum = userAll.onlineNum;
  state.totalNum = userAll.totalNum;
  state.alarmNum = userAll.alarmNum;
  setOption();
